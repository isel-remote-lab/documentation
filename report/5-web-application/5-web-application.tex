...
\begin{figure}[H]
    ...
    \end{minipage}
    \caption{Authentication flow: (a) login screen; (b) Microsoft OAuth login page shown after clicking the login button.}
...
\begin{figure}[H]
    \centering
    \includegraphics[trim=1600 1100 0 0,clip,width=0.3\linewidth]{../img/website-screenshots/21-account-dropdown.png}
