...
It is important to note that these API requests are performed on the server side, meaning the user cannot directly see or inspect these requests from their browser. This enhances security and encapsulates sensitive operations away from the client.
