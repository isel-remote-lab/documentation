...
\begin{figure}[H]
    \centering
    \includegraphics[trim=0 400 0 0,clip,width=\linewidth]{../img/website-screenshots/9-fullscreen-create-laboratory.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[trim=0 300 0 0,clip,width=\linewidth]{../img/website-screenshots/15-group-users-management.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[trim=0 300 0 0,clip,width=\linewidth]{../img/website-screenshots/18-hardware-edition-screen.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[trim=0 200 0 0,clip,width=\linewidth]{../img/website-screenshots/19-laboratory-session.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[trim=0 600 0 0,clip,width=\linewidth]{../img/website-screenshots/21-tela-fila-de-espera.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[trim=1500 900 0 0,clip,width=0.3\linewidth]{../img/website-screenshots/21-account-dropdown.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[trim=0 200 0 0,clip,width=\linewidth]{../img/website-screenshots/22-profile-details.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[trim=0 100 0 0,clip,width=\linewidth]{../img/website-screenshots/23-change-user-role-dropdown.png}
