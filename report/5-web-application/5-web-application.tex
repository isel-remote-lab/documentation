...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\linewidth]{../img/website-screenshots/1-tela-inicial.png}
...
\begin{figure}[H]
    ...
    \caption{Microsoft OAuth login page, allowing users to authenticate using their university credentials.}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\linewidth]{../img/website-screenshots/4-tela-login.png}
    \caption{Login screen showing the authentication flow and user interface elements.}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\linewidth]{../img/website-screenshots/8-criar-lab-tela-cheia.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\linewidth]{../img/website-screenshots/9-mensagem-na-criacao.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\linewidth]{../img/website-screenshots/10-editar-lab.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\linewidth]{../img/website-screenshots/11-gerir-grupos-lab.png}
    \caption{Group management interface for laboratories, showing existing groups and management options.}
    \label{fig:manage-lab-groups}
\end{figure}

\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\linewidth]{../img/website-screenshots/12-criar-grupo-lab.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\linewidth]{../img/website-screenshots/13-grupo-criado.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\linewidth]{../img/website-screenshots/14-gerir-utilizadores-grupo.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\linewidth]{../img/website-screenshots/15-gerir-hardware-lab.png}
    \caption{Hardware management interface for laboratories, showing available equipment and configuration options.}
    \label{fig:manage-lab-hardware}
\end{figure}

\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\linewidth]{../img/website-screenshots/16-hardware-adicionado-ao-lab.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\linewidth]{../img/website-screenshots/17-editar-hardware.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\linewidth]{../img/website-screenshots/18-inicio-sessao-lab.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\linewidth]{../img/website-screenshots/19-final-sessao-lab.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\linewidth]{../img/website-screenshots/20-tela-fila-de-espera.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\linewidth]{../img/website-screenshots/21-dropdown-conta.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\linewidth]{../img/website-screenshots/22-detalhes-propria-conta.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\linewidth]{../img/website-screenshots/23-dropdown-mudanca-papel-administrador.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\linewidth]{../img/website-screenshots/5-movimentar-redimensionar-modal-validacao-input.png}
