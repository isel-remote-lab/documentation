...
\begin{figure}[H]
    \centering
    \includesvg[inkscapelatex=false, width=1.05\linewidth]{../img/DB-diagrams/ERDiagramRL.drawio.svg}
...
\begin{figure}[H]
    \centering
    \includesvg[inkscapelatex=false, width=0.5\linewidth]{../img/DB-diagrams/LabSession.drawio.svg}
